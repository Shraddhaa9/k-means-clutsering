...
# Loading the dataset 
file_path = r'/Users/shraddharakholiya/projects/python-ml/Clustering/Merged_Subsampling_Remove Outliers_Normalize by Ground Points_Point Cloud Segmentation.csv'
...
output_file_path = r'./selected_trees_for_removal.csv'
